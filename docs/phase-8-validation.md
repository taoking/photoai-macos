...
- 每张人物卡片从已有本地缩略图中裁剪并显示一张人脸主预览，面积较大的人脸优先；其余候选样本以数量提示呈现，避免在自适应网格中溢出。可点击“查看照片”回到图库并定位来源照片。未命名人物会显示直接命名输入框及说明，便于辨认后再保存名称。
...
- 2026-08-12 已在现有人物分组数据上验证：每张人物卡片都以独立、等宽布局显示关联照片主预览、样本数量、来源照片定位和命名输入入口；验证期间未写入人物名称，未重新分析照片。
